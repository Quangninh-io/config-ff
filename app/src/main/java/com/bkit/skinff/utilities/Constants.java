...
public class Constants {
    ...
    public static final String INTENT_CHOSE_MODEL = "model";
    ...
    public static final String INTENT_WEAPON = "uriWeapon";
    public static final String INTENT_OUTFIT = "uriOutfit";
